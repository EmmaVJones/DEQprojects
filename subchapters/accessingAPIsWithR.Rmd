...
Let's investigate the first dataset called "Groups." To do so in a browser, we would simply augment our original URL to include "Groups" endpoint, e.g. [https://cmc.vims.edu/odata/Groups](https://cmc.vims.edu/odata/Groups) .
