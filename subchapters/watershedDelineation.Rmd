...
# for later download
myScriptPath<-'./functions/StreamStatsAutoDelineation.R'
...
source('../functions/StreamStatsAutoDelineation.R') # for custom web scraping tool to hit USGS StreamStats API
