...
```{r child = 'subchapters/spatialDataFromTabularData.Rmd', cache=TRUE}
```
...
```{r child = 'subchapters/Consuming_GIS_REST_Services_In_R.Rmd', cache=TRUE}
```
...
```{r child = 'subchapters/spatialOperationsOnGISRESTServicesInR.Rmd', cache=TRUE}
```
